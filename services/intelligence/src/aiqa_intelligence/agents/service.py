...
from ..contracts.validation import validate_case_input, validate_cases, validate_rules, validate_rule_input
...
class AgentPipelines:
    ...
    async def extract_rules(
        ...
        validate_rule_input(input.model_dump(mode="json", exclude_unset=True))

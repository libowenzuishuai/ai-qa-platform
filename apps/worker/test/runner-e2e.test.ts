...
for(const [kind,name,verdict] of [['NODE_TEST','node-pass','PASS'],['NODE_TEST','node-fail','FAIL'],['PYTHON_TEST','python-pass','PASS'],['PYTHON_TEST','python-fail','FAIL'],['NODE_HTTP','node-http','PASS']] as const){

...
import { ApiErrorBody, DEFAULT_HTTP_STATUS_BY_CODE, } from "@ai-qa/contracts";
/**
...
export function sendApiError(req, reply, error) {
    ...
    if (error?.code === "FST_ERR_CTP_BODY_TOO_LARGE") {
        reply.code(413).send({ code: "VALIDATION_ERROR", message: "上传文件超过大小限制", requestId });
        return;
    }
